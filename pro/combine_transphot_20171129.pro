pro combine_transphot_20171129

; This combines the output transformation equations for all the filters
; for 20171129 and with the older ones

files = file_search('/dl1/users/dnidever/smash/cp/red/photred/stdred_20171129/transphot_?_eqns_20171129.fits',count=nfiles)
...
outfile = '/dl1/users/dnidever/smash/cp/red/photred/stdred/smashred_transphot_eqns.fits'
