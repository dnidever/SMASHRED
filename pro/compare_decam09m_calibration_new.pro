pro compare_decam09m_calibration_new,save=save
...
;restore,'/data/smash/cp/red/photred/0.9m/compare_decam09m_calibration_new.dat'
;goto,makeplots
...
;save,mallobj,mstr,offstr,file='/data/smash/cp/red/photred/0.9m/compare_decam09m_calibration_new.dat'
...
if keyword_set(save) then begin
  spawn,'gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=/data/smash/cp/red/photred/0.9m/plots/compare_decam09m_calibration_new.pdf '+strjoin(pdffiles,' ')
endif
