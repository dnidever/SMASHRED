pro make_allobj_sharpfixed

;; Remake the v4 allobj SMASH catalogs with sharp values
;; "fixed", i.e. not using S/N<5 ALLSTAR sharp values.
;; Put the final catalogs inf v4b/
...
for i=0,nfiles-1 do begin
  ...
  smashred_averagemorphcoord,fstr,chstr,allsrc,allobj,/alslowsnrcut

  ; Write out new allobj file
  outfile = rootdir+'cp/red/photred/catalogs/final/v4b/'+ifield+'_combined_allobj.fits'
