pro combine_transphot_20170804

; This combines the output transformation equations for all the filters
; for 20170804 and with the older ones

files = file_search('/dl1/users/dnidever/smash/cp/red/photred/stdred_20170804/transphot_?_eqns_20170804.fits',count=nfiles)
