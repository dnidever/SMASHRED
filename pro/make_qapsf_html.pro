...
for i=0,nnights-1 do begin
  ...
  for j=0,nfstr-1 do begin
    ...
    printf,unit,'<tr>'
    printf,unit,'<td><a href="'+expnum+'_img.png" target="main"><img src="'+expnum+'_img.png" width=600></a></td>'
    printf,unit,'<td><a href="'+expnum+'_psf.png" target="main"><img src="'+expnum+'_psf.png" width=600></a></td>'
    printf,unit,'<td><a href="'+expnum+'_sub.png" target="main"><img src="'+expnum+'_sub.png" width=600></a></td>'
    printf,unit,'</tr>'
    printf,unit,'</table>'
    printf,unit,'</BODY>'
    printf,unit,'</HTML>'
