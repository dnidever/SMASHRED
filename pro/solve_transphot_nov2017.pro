pro solve_transphot_nov2017,file,fitcolam=fitcolam,errlim=errlim,arr=arr,mstr=mstr_fixcolzpam,resid=resid_fixcolzpam,$
...
; Derive transformation equations for the SMASH Novermber 29, 2017
; DD half-night.

if n_elements(file) eq 0 then begin
  print,'Syntax - solve_transphot_nov2017,file'
  return
endif
...
print,'RUNNING SOLVE_TRANSPHOT_NOV2017 ON  >> ',file,' <<'

rootdir = '/dl1/users/dnidever/'
reduxdir = rootdir+'smash/cp/red/photred/'
plotsdir = rootdir+'smash/cp/red/photred/stdred_20171129/plots/'
...
outfile = 'transphot_'+filter+'_eqns_20171129.fits'
