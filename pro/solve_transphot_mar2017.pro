pro solve_transphot_mar2017,file,fitcolam=fitcolam,errlim=errlim,arr=arr,mstr=mstr_fixcolzpam,resid=resid_fixcolzpam,$
...
; Derive transformation equations for the SMASH March 8, 2017
; DD half-night.

if n_elements(file) eq 0 then begin
  print,'Syntax - solve_transphot_mar2017,file'
  return
endif
...
print,'RUNNING SOLVE_TRANSPHOT_MAR2017 ON  >> ',file,' <<'

rootdir = '/dl1/users/dnidever/'
reduxdir = rootdir+'smash/cp/red/photred/'
plotsdir = rootdir+'smash/cp/red/photred/stdred_201703/plots/'
