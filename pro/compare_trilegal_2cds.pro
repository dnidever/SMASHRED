...
for i=0,n_elements(color1)-1 do begin
  ...
  !p.font = 0
  setdisp
  file = plotsdir+'trilegal_2cds_'+field+'_'+repstr(color1[i],'-','')+'_'+repstr(color2[i],'-','')
  ...
  displayc,tim,xarr,yarr,xtit=color1[i],ytit=color2[i],tit='TRILEGAL Simulation',/log,/noerase,$
